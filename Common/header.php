    ...
    <div class="alt-panel" role="dialog" aria-modal="true" aria-label="Site menu">
        <nav>
            <?php if ($headerMode === 'dashboard'): ?>
                ...
                <a href="<?php echo esc_attr(BASE_PATH); ?>/dashboard/assign_worker.php">Assign Worker</a>
                <a href="<?php echo esc_attr(BASE_PATH); ?>/dashboard/goods_manage.php">Goods Management</a>
